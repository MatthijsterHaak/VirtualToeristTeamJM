...
export default class App extends React.Component {
  ...
  HandleData = async () => { 
    ...
    var activityStartDatetime = ((Startdate.getDate())) + '-' + ("0" + (Startdate.getMonth()+1)) + '-' + Startdate.getFullYear().toString().substr(-2) + 'T' + ("0" + (Startdate.getHours())).slice(-2) + ':' +  ("0" + (Startdate.getMinutes())).slice(-2) + ':' + ("0" + (Startdate.getSeconds())).slice(-2) + ':' + Startdate.getMilliseconds() + 'Z';

    //activityStopDatetime
    var Stopdate = new Date(dataTrackedRoute[dataTrackedRoute.length - 1]['timestamp'])
    var activityStopDatetime = ((Stopdate.getDate())) + '-' + ("0" + (Stopdate.getMonth()+1)) + '-' + Stopdate.getFullYear().toString().substr(-2) + 'T' + ("0" + (Stopdate.getHours())).slice(-2) + ':' +  ("0" + (Stopdate.getMinutes())).slice(-2) + ':' + ("0" + (Stopdate.getSeconds())).slice(-2) + ':' + Stopdate.getMilliseconds() + 'Z';
    ...
    var activityDescriptionStr = ((Startdate.getDate())) + '-' + ("0" + (Startdate.getMonth()+1)) + '-' + Startdate.getFullYear().toString().substr(-2) + 'T' + ("0" + (Startdate.getHours())).slice(-2) + ':' +  ("0" + (Startdate.getMinutes())).slice(-2) + ':' + ("0" + (Startdate.getSeconds())).slice(-2) + ':' + Startdate.getMilliseconds() + 'Z';
